...
roslaunch Database gazebo.launch world:=/mnt/shared/catkin_ws/src/ProVANT-Simulator_Developer/source/Database/worlds/worlds/iuro/husky_1obs/husky_rnd.world control_strategy:=/mnt/shared/catkin_ws/src/ProVANT-Simulator_Developer/source/Database/models/husky2/config/config.xml
